...
exports.MARKET = {
  ...
  currencies: {
    ...
    AUD: { symbol: 'A$', fractionDigits: 4 },
    BRL: { symbol: 'R$', fractionDigits: 4 },
    CAD: { symbol: 'C$', fractionDigits: 4 },
    CHF: { symbol: 'CHF', fractionDigits: 4 },
    CNY: { symbol: '¥', fractionDigits: 4 },
    EUR: { symbol: '€', fractionDigits: 4 },
    GBP: { symbol: '£', fractionDigits: 4 },
    HKD: { symbol: 'HK$', fractionDigits: 4 },
    IDR: { symbol: 'IDR', fractionDigits: 4 },
    INR: { symbol: '₹', fractionDigits: 4 },
    JPY: { symbol: '¥', fractionDigits: 0 },
    KRW: { symbol: '₩', fractionDigits: 0 },
    MXN: { symbol: 'MX$', fractionDigits: 4 },
    RUB: { symbol: '₽', fractionDigits: 4 },
    USD: { symbol: '$', fractionDigits: 4 }
  }
}
